...
export async function recoverZombieTransactions() {
    ...
    try {
        ...
        if (err.code === 9 || err.message.includes('index')) {
            logger.error("\n[CRITICAL] Missing Firestore Index: Transaction recovery is currently DISABLED.");
            logger.error(">>> RESOLUTION: Visit the following URL to create the required composite index:");
            logger.error(">>> https://console.firebase.google.com/v1/r/project/dreambees-alchemist/firestore/indexes?create_composite=Cl9wcm9qZWN0cy9kcmVhbWJlZXMtYWxjaGVtaXN0L2RhdGFiYXNlcy8oZGVmYXVsdCkvY29sbGVjdGlvbkdyb3Vwcy9hcnRib3RfdHJhbnNhY3Rpb25zL2luZGV4ZXMvXxABGgoKBnN0YXR1cxABGg0KCXRpbWVzdGFtcBABGgwKCF9fbmFtZV9fEAE\n");
        } else {
