...
_CLOUD_TASKS_LOCATION=${CLOUD_TASKS_LOCATION},\
_CLOUD_TASKS_QUEUE=${CLOUD_TASKS_QUEUE},\
_TASK_WEBHOOK_URL=${TASK_WEBHOOK_URL},\
_CLOUD_TASKS_SA_EMAIL=${CLOUD_TASKS_SA_EMAIL}"
