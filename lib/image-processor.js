...
import { uploadToS3, B2_PUBLIC_URL } from './s3.js';
...
/**
 * High-level pipeline: processes a raw buffer, uploads to B2, and records in Firestore.
 */
export async function processAndUploadSingleImage(buffer, userId, metadata = {}) {
    return imageLimit(async () => {
        ...
        try {
            ...
            // 3. Save to Firestore 'images' collection
